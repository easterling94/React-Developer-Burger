...
export const BurgerIngredients = () => {
  ...
  const { ingredientsTab, ingredients } = useAppSelector(
  ...
  return (
    <section className={styles.section}>
      <nav className={styles.nav} id='nav'>
        <Tab
          value={INGREDIENTS_TYPES[0].type}
          active={ingredientsTab === INGREDIENTS_TYPES[0].type}
          onClick={() => scrollToView(INGREDIENTS_TYPES[0].type)}
        >
          {INGREDIENTS_TYPES[0].name}
        </Tab>
        <Tab
          value={INGREDIENTS_TYPES[1].type}
          active={ingredientsTab === INGREDIENTS_TYPES[1].type}
          onClick={() => scrollToView(INGREDIENTS_TYPES[1].type)}
        >
          {INGREDIENTS_TYPES[1].name}
        </Tab>
        <Tab
          value={INGREDIENTS_TYPES[2].type}
          active={ingredientsTab === INGREDIENTS_TYPES[2].type}
          onClick={() => scrollToView(INGREDIENTS_TYPES[2].type)}
        >
      ...
      <div className={styles.itemsList} onScroll={changeView}>
        <ItemsList
          id='bun'
          name={INGREDIENTS_TYPES[0].name}
          ingredients={BUNS}
        />
        <ItemsList
          id='main'
          name={INGREDIENTS_TYPES[1].name}
          ingredients={MAIN}
        />
        <ItemsList
          id='sauce'
          name={INGREDIENTS_TYPES[2].name}
          ingredients={SAUCE}
        />
      </div>
    </section>
